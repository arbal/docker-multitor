...
# Build
git clone https://github.com/arbal/docker-multitor
...
docker run --rm -p 16379:16379 arbal/multitor

# Start 20 tor instances
docker run --rm -e "TOR_INSTANCES=20" -p 16379:16379 arbal/multitor 
```
...
```bash
# run interactive
docker run --name multitor -it -p 16379:16379 arbal/multitor /bin/bash
